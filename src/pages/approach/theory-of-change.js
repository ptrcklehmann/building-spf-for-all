    ...
    return (
        <Layout>
            ...
            <HeroSmall title="Theory of change" bgImage='/images/approach/theory-of-change.jpg' />
                ...
                <div className="container">
                    <div className="row align-items-start justify-content-start pb-3 space-vertical sm-column">
                        <ScrollAnimation animateIn="animate__fadeInUp">
                            <h1 className="section-subtitle-bold ">Our vision</h1>
                        </ScrollAnimation>
                        <h3 className="col-lg-12 col-md-12 col-sm-12 body-large-heading mt-lg-2">Our vision is a world where all countries have national social protection systems that: </h3>
